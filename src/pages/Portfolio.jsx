  ...
  return (
    <>
      ...
      <div className="min-h-screen py-10">
        <h1
          className="text-4xl mr-200 mb-4 text-center text-white font-bold"
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-10 mb-20">
          ...
          <div className="max-w-lg">
            <h1 className="text-3xl text-white  mb-4  ml-35" style={{ fontFamily: "Lora" }}>
              Bikes and Beards
            </h1>
            ...
            <div className="flex items-center gap-15 ml-40">
        ...
        <div className="flex flex-col md:flex-row-reverse items-center justify-center gap-10 mb-20">
          ...
          <div className="max-w-lg text-gray-300">
            <h2 className="text-2xl text-white mb-3 ml-50" style={{ fontFamily: "Lora" }}>
              Learnify
            </h2>
